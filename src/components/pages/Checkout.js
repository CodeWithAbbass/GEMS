...
const Checkout1 = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // setCheckoutInfo({ phone: "", fName: "", lName: "", address: "", city: "", state: "", email: "", });
        SaveUserInfo(checkoutInfo);
        Navigate("/payment");
    };
    const onChange = (e) => {
    ...
    if (cart.length === 0) {
        return (
            <div className="Continue_Shopping w-100 d-flex flex-column justify-content-center align-items-center">
                <h1 className="EmptyStateTitle">Your Cart is Empty Please Add to Cart Atleast 1 Product to Checkout</h1>
